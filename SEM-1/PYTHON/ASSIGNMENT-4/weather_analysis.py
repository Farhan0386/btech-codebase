...
def load_and_clean_data(file_path: str) -> pd.DataFrame:
    ...
    # Interpolate numeric columns linearly over time
...
def analyze_data(df: pd.DataFrame) -> pd.DataFrame:
    ...
    """
    # Expected column names: 'Temperature_C', 'Rainfall_mm'
    # Create safe defaults if columns are missing
    ...
    # Use 'ME' (month-end) to avoid FutureWarning for deprecated 'M'
